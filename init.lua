...
function fault_packet_int(fault_total)
    ...
    for i=1,fault_total * 9,1 do
        ...
        if i % 9 == 0 then
            packet[ "fault"..m.."time" ] = temp_time["fault"..m.."year"].."_"..temp_time["fault"..m.."month"].."_"..temp_time["fault"..m.."day"].."-"..temp_time["fault"..m.."hour"]..':'..temp_time["fault"..m.."min"]..':'..temp_time["fault"..m.."sec"]
        end
